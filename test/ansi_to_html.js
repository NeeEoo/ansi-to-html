...
describe('ansi to html', function () {
    describe('constructed with no options', function () {
        ...
        it('renders foreground colors', function (done) {
            ...
            const result = 'colors: <span style="color:#000">black<span style="color:#ccc">white</span></span>';
        ...
        it('renders background colors', function (done) {
            ...
            const result = 'colors: <span style="background-color:#000">black<span style="background-color:#ccc">white</span></span>';
